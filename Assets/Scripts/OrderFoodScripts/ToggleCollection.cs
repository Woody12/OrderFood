        ...
        protected virtual void OnSelection(int index)
        {
            for (int i = 0; i < Toggles.Count; i++)
            {
                ...
                else
                {
                    ...
                    Debug.Log("Category Toggle :: Food Index " + i + "Selected");
                    //Here is where we would call for the Category of food wanted, right now being controlled by the Menu Controller and JSON.
                }
            }
